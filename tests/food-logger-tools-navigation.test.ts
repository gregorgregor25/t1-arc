...
function navigation(overrides: Record<string, unknown> = {}) {
  ...
  for (const component of ['View', 'Pressable', 'Text', 'TextInput', 'Ionicons', 'ActivityIndicator', 'FoodToolsPage', 'FoodCatalogueExtras', 'LabelConventionPicker', 'FoodPhotoField']) scope[component] = component;

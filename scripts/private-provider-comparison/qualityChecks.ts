export type DiscriminatingCaseId = "event-count-priority" | "zero-recorded-events" | "education-calibration" | "education-calibration-paraphrase" | "education-calibration-limits";

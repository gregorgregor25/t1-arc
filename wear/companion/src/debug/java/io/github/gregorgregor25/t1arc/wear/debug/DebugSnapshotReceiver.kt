package io.github.gregorgregor25.t1arc.wear.debug
...
class DebugSnapshotReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val repository = T1ArcWearRepository.get(applicationContext)
        if (intent.getBooleanExtra("clear", false)) {
            ...
            repository.save(
                GlucoseSnapshot(
                    ...
                    sourceLabel = "T1 Arc debug fixture",
        ...
        T1ArcDataLayerSync.refreshSurfaces(applicationContext)
    }

    private companion object {
        const val ACTION = "io.github.gregorgregor25.t1arc.wear.DEBUG_SET_GLUCOSE"
    }
}

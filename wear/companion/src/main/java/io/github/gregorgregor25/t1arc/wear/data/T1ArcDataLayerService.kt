...
class T1ArcDataLayerService : WearableListenerService() {
    ...
    override fun onMessageReceived(messageEvent: MessageEvent) {
        ...
        val changed =
            T1ArcDataLayerSync.acceptMessage(
                this,
                messageEvent.path,
                messageEvent.data,
            )
        ...
        if (changed) {
            T1ArcDataLayerSync.refreshSurfaces(this)
        }
    }
}

...
class T1ArcWatchView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (snapshot == null) {
            ...
            drawText(canvas, GlucoseSemantics.unitLabel(snapshot!!), 225f, 258f, 16f, Color.rgb(169, 189, 194), Paint.Align.CENTER, true)

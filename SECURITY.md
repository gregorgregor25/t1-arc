...
is unavailable, email **support@t1arc.com** privately; do not post exploit
details or personal data in a public issue.
...
Maintainers must verify those protections before adding signing secrets or
dispatching the public release workflow. Local candidate builds are a separate
preparation step. See

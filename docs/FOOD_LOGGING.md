...
1. On Today, tap **+**, choose **Food**, and choose the meal you want to add.
...
Review its suggested basis and values, select the pack's label format, confirm
that you checked the values, choose **Use checked values**, then check
...
## Food, meal and recipe photos

You can attach a photo to a personal food, meal or recipe. Product results may
also have an Open Food Facts image. Photos help identify saved items; they do
not estimate carbohydrates or portions. Saved copies stay in the encrypted
local database and are included in portable backups. Label-recognition photos
are temporary and are not automatically kept as food photos.

...
Connection and workout import have been checked with a real Hevy account.
Automated tests use contract fixtures and do not contact Hevy or expose a
private key. Automatic refresh is best effort; see [data freshness](DATA_FRESHNESS.md).

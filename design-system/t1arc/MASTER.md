...
| Navigation / chart accent | `#3156B8` | `#8EA7FF` |
...
In-range glucose is green by default. Use the configured glucose range colours
for glucose presentation, preserving the user’s saved choices. Maintain readable labels and trend arrows alongside the
colour.

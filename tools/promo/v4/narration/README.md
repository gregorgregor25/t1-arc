...
| `../scripts/export-food-refresh.mjs` | Food scene replacement; existing audio/captions unchanged |
...
source provenance stay in private production records. See the
[production steps](../PRODUCTION.md) for reproduction with authorised inputs.
...
Keep usage counts, audition comparisons and delivery reports outside the public repository.

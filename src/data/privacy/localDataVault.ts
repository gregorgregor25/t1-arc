  ...
  const before = await withT1ArcSanitizedEraseTransaction(
    async (transaction) => {
      ...
      for (const statement of [
        ...
        "DELETE FROM app_metadata WHERE key = 'support-diagnostics-v1'",
        "DELETE FROM app_metadata WHERE key LIKE 'connection-history-v1:%'",
        "DELETE FROM app_metadata WHERE key = 'nutrition-display-source-v1'",
        ...
        `DELETE FROM app_metadata WHERE key LIKE 'recovered-owner-proof-v1:%'`,

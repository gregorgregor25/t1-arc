...
export interface GlookoSyncState {
  ...
  /**
   * Legacy migration field only. New account ownership uses the keyed
   * fingerprint below; credential generations only invalidate in-flight work.
   */
  ...
  /** Durable one-time attestation while a legacy binding retry is pending. */
  pendingLegacyCredentialContinuity?: boolean;

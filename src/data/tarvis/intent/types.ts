...
export type TarvisProvenanceKind =
  "explicit" | "conversation" | "profile" | "default" | "derived";
...
export type TarvisTemporalScope =
  ...
  | {
       ...
       */
      include:
        "through_now" | "completed_days" | "most_recent_completed_windows";
    }
  | {
...
export type TarvisComparison =
  { kind: "previous_equal_period" } | { kind: "explicit_periods" };
...
export interface TarvisIntentV1 {
  ...
  thresholds: TarvisIntentField<TarvisGlucoseThreshold>[];
}
...
export interface ReadyTarvisIntentResolution extends TarvisIntentResolutionBase {
  outcome: Extract<TarvisCapabilityOutcome, { status: "ready" }>;
  intent: TarvisIntentV1;
}

export interface IncompleteTarvisIntentResolution extends TarvisIntentResolutionBase {
  outcome: Exclude<TarvisCapabilityOutcome, { status: "ready" }>;
  intent: TarvisIntentDraftV1;
}

export type TarvisIntentResolution =
  ReadyTarvisIntentResolution | IncompleteTarvisIntentResolution;

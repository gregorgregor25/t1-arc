...
import { FoodCompletenessAction } from '@/components/FoodCompletenessAction';
import { HypoTreatmentReviewCard } from '@/components/HypoTreatmentReviewCard';
  ...
  return (
    <View style={styles.stack}>
      ...
      <FoodDiaryCard
        ...
        onInspect={onInspect}
      />
      {days === 1 ? <FoodCompletenessAction data={data} /> : null}
      <HypoTreatmentReviewCard data={data} />
      {foodError ? (
        <ErrorCard

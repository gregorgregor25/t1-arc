...
import { SupportReportCard } from "@/components/SupportReportCard";
...
import { FoodSourceCard } from '@/components/FoodSourceCard';
...
export function SourcesScreen({
  ...
  return (
    ...
    >
      ...
      {activeSource === 'libre' ? <ConnectionHistoryCard /> : null}
      ...
      {activeSource === "support" ? (
        <View style={styles.settingsSections}><SupportReportCard /></View>
      ) : null}
      ...
      {activeSource === "watch" ? <WearCompanionCard /> : null}
      ...
      {activeSource === "privacy" ? (
        <View style={styles.settingsSections}>
          <SectionCard><PrivacyPolicyLink /></SectionCard>
          {__DEV__ ? (
            <SettingsDisclosure

...
/**
 * Builds adjacent, non-overlapping London-calendar windows. The selected date
 * is the final included day. Calendar boundaries keep comparisons correct
 * across British Summer Time transitions.
 */

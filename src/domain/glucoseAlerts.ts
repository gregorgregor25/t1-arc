...
export function validateGlucoseAlertPreferences(
  ...
  if (
    ...
    return 'The low alert must be between 2.0 and 6.0 mmol/L.';
  }
  if (
    ...
    return 'The high alert must be between 7.0 and 25.0 mmol/L.';
  }
  if (value.lowThresholdMmolL + 1 > value.highThresholdMmolL) {
    return 'Keep at least 1.0 mmol/L between the low and high alerts.';
  }

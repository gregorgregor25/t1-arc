...
import { isManualInsulinDelivery, possibleImportedDoseOverlap } from '@/data/manualInsulin';
          ...
          return (
            ...
            >
              ...
              <View style={styles.rowCopy}>
                {possibleImportedDoseOverlap(delivery, boluses) ? <Text style={{ color: colors.warning }}>Possible duplicate of an imported dose. Edit or remove the manual entry if it records the same injection.</Text> : null}

      ...
      ? selectedNutritionDay.nutritionPossibleDuplicatePairs > 0
        ...
        : (selectedNutritionCoverage?.partialCount ?? 0) > 0
          ...
          : selectedNutritionCoverage && selectedNutritionNeedsReview
            ...
            : `${formatRegionalNumber(selectedNutritionDay.mealCount, regional.locale, { maximumFractionDigits: 0 })} ${selectedNutritionDay.mealCount === 1 ? "food entry" : "food entries"} logged`
      : undefined;
    const nutrientValue = (
        ...
        primary: selectedNutritionDay
          ? selectedNutritionDay.mealCarbsGrams !== undefined
            ...
            : selectedNutritionDay.mealEnergyKcal !== undefined
              ...
              : `${formatRegionalNumber(selectedNutritionDay.mealCount, regional.locale, { maximumFractionDigits: 0 })} food ${selectedNutritionDay.mealCount === 1 ? "entry" : "entries"}`
          : "No record",
        status: nutritionStatus ?? "No meals for this day",
        detail: selectedNutritionDay
          ? [
              "Available nutrients and food or hypo-treatment times stored for the selected day.",
              ...
              .filter(Boolean)
              .join(" ")
          : "No food entries are available for the selected day. Earlier entries remain in the seven-day chart.",
        chart: "bar",
        summary: "total",
        format: (value) =>
          nutritionSeries === "carbs"

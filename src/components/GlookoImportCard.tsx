...
import { getGlookoImportPhase, subscribeGlookoImportPhase } from '@/data/glooko/importProgress';
import {
  ActivityIndicator,
  Platform,
  Pressable,
...
export function GlookoImportCard() {
  const automaticImportPhase = useSyncExternalStore(subscribeGlookoImportPhase, getGlookoImportPhase);
        ...
        {credentialConfigured ? (
          <View style={styles.automaticTop}>
            <View style={styles.automaticCopy}>
              ...
              >
                {credentialBusy || glookoSyncing
                  ? "Checking the connection and bringing your history up to date."
        ...
        <ImportProgressNotice
          stage={
            state.kind === "importing"
              ? "save"
              : state.kind === "preparing"
                  ? (state.stage ?? automaticImportPhase ?? "sync")
                  : automaticImportPhase ?? "sync"
          }
        />
      ) : null}

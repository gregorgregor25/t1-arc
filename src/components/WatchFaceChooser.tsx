...
export function WatchFaceChooser({ refreshKey = 0 }: { refreshKey?: number } = {}) {
  ...
  return (
    <View style={styles.root}>
      ...
      <Pressable accessibilityRole="button" accessibilityState={{ disabled: !installAllowed, busy: working }}
        accessibilityLabel={working ? `Setting up ${selectedFace.name} on watch` : `Use ${selectedFace.name} on watch`}

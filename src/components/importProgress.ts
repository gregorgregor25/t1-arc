...
export type ImportProgressStage = "sync" | "export" | "read" | "save" | "report";

export const IMPORT_PROGRESS_COPY: Record<
  ImportProgressStage,
  { title: string; detail: string }
> = {
  export: { title: 'Requesting your Glooko export', detail: 'Waiting for Glooko to prepare and send your records. A first import can take several minutes; your existing history remains available.' },
  sync: {
  ...
  read: {
    ...
    detail:
      "Checking dates, units and records on this phone before saving them.",
  },
  save: {

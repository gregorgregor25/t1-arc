...
import './src/data/background/hevySyncTask';
...
import { ensureRegionalProfileRuntimeHydrated } from './src/data/regionalProfile';

AppRegistry.registerHeadlessTask(
  GLUCOSE_DISPLAY_HEADLESS_TASK,
  () => async (taskData) => {
    await ensureRegionalProfileRuntimeHydrated();
    return runGlucoseDisplayForegroundSync(taskData);
  },
);
